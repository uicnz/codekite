...
* DocstringIndexer - builds a vector index of per-file summaries generated by
  a ``codekite.Summarizer``.  The index is stored in a pluggable
  :class:`codekite.vector_searcher.VectorDBBackend` (default: Chroma).
...
class DocstringIndexer:
    ...
    ----------
    repo
        Active :py:class:`codekite.repository.Repository`.
    summarizer
        Configured :py:class:`codekite.summaries.Summarizer`.
    embed_fn
        ...
        if embed_fn:
            ...
            try:
                ...
                raise ImportError(
                    ...
                    "Please install it (e.g., 'pip install codekite[default-embeddings]' or 'pip install sentence-transformers') "
