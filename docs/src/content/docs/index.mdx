---
title: CodeKite Documentation
template: doc
tableOfContents: false
bodyClass: codekite-homepage
---
...
Welcome to **codekite** - the Python toolkit from [Shane Holloman](https://shaneholloman.dev) for building LLM-powered developer tools and workflows. codekite shines for getting \*\*precise, accurate, and relevant context\*\* to LLMs. Use codekite to build code reviewers, code generators and graphs, even full-fledged coding assistants: all enriched with the right code context. MIT-licensed on \[GitHub\](https://github.com/shaneholloman/codekite).
...
<CardGroup cols={2}>
  <Card title="Overview" href="/introduction/overview">
    What codekite is, why it exists, and how to install it.
  </Card>
  ...
  <Card title="Tutorials" href="/tutorials/ai_pr_reviewer">
    Step-by-step tutorials to build real-world tools with codekite.
  </Card>
