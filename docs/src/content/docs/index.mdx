...
<div class="hero-image">
  ...
  <div class="hero-text">
    Welcome to **kit** – the Python toolkit from [Shane Holloman](https://shaneholloman.dev) for building LLM-powered developer tools and workflows.
    ...
    MIT-licensed on [GitHub](https://github.com/shaneholloman/codekit).
  </div>
</div>
