---
title: Codebase Q&A with Summaries
---
...
*   You have `codekite` installed (`pip install codekite`).
...
1.  **Initialize Components**
    ...
    ```python
    from codekite import Repository, DocstringIndexer, Summarizer, SummarySearcher, ContextAssembler
    from codekite.llms.openai import OpenAIConfig # Or AnthropicConfig, GoogleConfig
