...
This tutorial explains how to use `codekite` to dump a complete map of your repository—including the file tree and all extracted symbols—as a JSON file. This is useful for further analysis, visualization, or integration with other tools.
...
def main():
    parser = argparse.ArgumentParser(description="Dump a repository's file tree and symbols as JSON using codekite.")
    ...
    try:
        ...
        mapper = codekite.RepoMapper(repo_path)
