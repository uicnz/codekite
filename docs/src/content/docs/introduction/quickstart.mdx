...
Now, you can use codekite!
codekite ships with a demonstration repository at `tests/fixtures/` you can use to get started.

Try this simple Python script (e.g., save as `test_kit.py` in the `codekite` directory you cloned):
...
# Ensure you have cloned the 'codekite' repository and are in its root directory
